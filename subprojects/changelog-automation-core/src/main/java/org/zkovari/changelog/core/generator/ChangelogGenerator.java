...
public class ChangelogGenerator {
    ...
    public String generate(String currentChangelogContent, Release release) {
        ...
        if (foundLastVersion) {
            ...
            newChangelog = matcher.replaceFirst(newReleaseEntry + NEW_LINE + previousVersion);
        } else {
    ...
    private String getChangelogHeader() {
        ...
        return new StringBuilder("# Changelog").append(NEW_LINE)
                ...
                .append(NEW_LINE)
                .append("The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/),")
                .append(NEW_LINE)
                .append("and this project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).")
